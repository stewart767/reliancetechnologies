...
<head>
    ...
    <title>Forbidden | Reliance Solutions & Technology</title>
...
<body class="h-full font-sans antialiased text-slate-355 bg-slate-950 flex flex-col items-center justify-center p-6 text-center">
    ...
    <div class="space-y-6 max-w-md">
        <span class="text-xs font-bold text-red-500 uppercase tracking-widest block">Error 403</span>
        <h1 class="font-title font-extrabold text-4xl sm:text-5xl text-white tracking-tight">Access Denied</h1>
        <p class="text-sm leading-relaxed text-slate-500">
            Your current session token lacks the required permissions to inspect this administrative resource.
        </p>
        <div class="pt-4">

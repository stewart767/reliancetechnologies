...
@section('seo')
    <x-seo 
        ...
        description="Terms and Conditions of Reliance Solutions & Technology."
    />
@endsection
...
@section('content')
    <header class="bg-slate-900 border-b border-slate-800 pt-32 pb-16 md:pt-40 md:pb-24">
        <div class="container space-y-4">
            ...
            <h1 class="font-title font-extrabold text-3xl sm:text-4xl text-white leading-tight">Terms & Conditions</h1>
        </div>
    </header>

...
<div class="space-y-8 max-w-3xl">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div class="space-y-2">
            <h1 class="font-title font-extrabold text-2xl md:text-3xl text-white">Create Service</h1>
            <p class="text-xs sm:text-sm text-slate-500">Draft a new corporate service capabilities segment.</p>
        </div>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="e.g. Cybersecurity Solutions"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="e.g. cybersecurity-solutions"
                           class="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-blue-500 transition-colors text-white">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="short_description" id="short_description" rows="3" required placeholder="A brief B2B marketing snippet..."
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="8" required placeholder="Full technical explanation..."
            ...
            <div class="space-y-4" x-data="{ capabilities: {{ json_encode(old('capabilities', [''])) }} }">
                ...
                <p class="text-[10px] text-slate-500 leading-relaxed">List specific B2B technical checkpoints included in this service.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="icon" id="icon" value="{{ old('icon') }}" placeholder="<svg>...</svg>"
                           class="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-blue-500 transition-colors text-white">
                </div>
